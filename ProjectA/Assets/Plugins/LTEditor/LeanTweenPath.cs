...
public class LeanTweenPath:MonoBehaviour {
	...
	public LeanTweenPathType pathType = LeanTweenPathType.spline;
  ...
  public Vector3 getPoint(float a) {
    Vector3 point = Vector3.zero;
    if(pathType==LeanTweenPathType.bezier){
      point = this.bezierPath.point(a);
    } else {
      point = this.splinePath.point(a);
    }
    return point;
  }
