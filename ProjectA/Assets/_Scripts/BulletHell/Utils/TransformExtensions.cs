...
{
    private static Vector3 m_tmpVector3 = Utils2D.VECTOR3_ZERO;
    private static Vector2 m_tmpVector2 = Utils2D.VECTOR2_ZERO;
    ...
    public static void ResetPosition(this Transform self, bool worldSpace = false)
    {
        if (worldSpace)
        {
            self.position = Utils2D.VECTOR3_ZERO;
        }
        else
        {
            self.localPosition = Utils2D.VECTOR3_ZERO;
        }
    }
    ...
    {
        self.localScale = Utils2D.VECTOR3_ONE;
    }
